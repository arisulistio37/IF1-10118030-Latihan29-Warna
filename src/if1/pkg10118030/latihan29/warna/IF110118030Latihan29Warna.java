 ...
 */
package if1.pkg10118030.latihan29.warna;
 ...
 * KELAS    : IF-1
 * NIM      : 1011830
 * Deskripsi Program : Program ini berisi tentang melihat kepribadian seseorang
 *                     dari warna kesukaan
 */
public class IF110118030Latihan29Warna {
    ...
    public static final String ANSI_BLACK_BACKGORUND = "\u001B[40m";
    ...
    public static void main(String[] args) {
        ...
        String[][] kep ={
            ...
            },
            {
                ...
                "Mudah cemburu,",
                "Mudah merasa iri,",
                "Menjungjung tinggi suatu nilai toleransi dan kepercayaan.",
            }
        };
        ...
        if (pilih==5)
            System.out.println("Oooops... Belum teridentifikasi");
        else{
